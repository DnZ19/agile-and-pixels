...
export default function Bottom() {
	return (
		<div className="relative h-1/4 bg-gradient-to-t from-tertiaryColor text-secondairyColor font-extralight w-full py-8 mx-16">
			<div className="absolute top-0 left-0 w-full"></div>
			<div className="container mx-auto z-10 relative">
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-8">
					<div className="text-cente md:text-left">
